...
const listingsSeed = [
  ...
  { title: "Gateaux individuels", category: "PASTRY", quantity: "20", unit: "unites", imageUrl: "https://images.unsplash.com/photo-1464306076886-debede6f791d?auto=format&fit=crop&w=1200&q=80", pickupMode: "DELIVERY", type: "BOTH", reduction: 50, description: "Parfaits pour associations enfants.", hours: 6, lat: 35.5158, lng: 11.0589 },
  { title: "Pates, riz et conserves", category: "GROCERY", quantity: "30", unit: "unites", imageUrl: "https://images.unsplash.com/photo-1584473457493-17c5f373286c?auto=format&fit=crop&w=1200&q=80", pickupMode: "BOTH", type: "DONATION", description: "Lots epicerie avec DLC longue.", hours: 48, lat: 35.5073, lng: 11.0675 },
  { title: "Huiles et legumes secs", category: "GROCERY", quantity: "15", unit: "unites", imageUrl: "https://images.unsplash.com/photo-1598511727534-7825748f0fba?auto=format&fit=crop&w=1200&q=80", pickupMode: "ON_SITE", type: "REDUCED_PRICE", reduction: 30, description: "Pack eco anti-gaspillage.", hours: 72, lat: 35.4929, lng: 11.0617 },
];
